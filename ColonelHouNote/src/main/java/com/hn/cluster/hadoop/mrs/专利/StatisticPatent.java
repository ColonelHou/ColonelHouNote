package com.hn.cluster.hadoop.mrs.专利;
...
/**
 * 统计专利 下载专利文件：http://data.nber.org/patents/ainventor.zip 解压上传到HDFS：
 * hadoop@hadoopMaster:~$ hdfs dfs -copyFromLocal ainventor.txt
 * /input/input/usData
 * 
 * @author Colonel.Hou
 * 
...
public class StatisticPatent extends Configured implements Tool
{
	...
	{
		String[] arg = {
				"hdfs://172.2.48.88:9000/input/input/usData/ainventor.txt",
				"hdfs://172.2.48.88:9000/output/usData/" };
