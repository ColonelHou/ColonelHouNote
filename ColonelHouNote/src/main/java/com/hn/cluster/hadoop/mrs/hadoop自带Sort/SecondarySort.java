package com.hn.cluster.hadoop.mrs.hadoop自带Sort;
...
/**
 * 创建文件输入一下内容soso.txt： 60 51 60 53 60 52 60 56 60 57 70 58 60 61 70 54 70 55 70
 * 56 70 57 70 58 1 2 3 4 5 6 7 82 拷贝到HDFS上 hadoop@hadoopMaster:~$
 * hdfsCOPYFROMLOCAL soso.txt /input/input
 * 
 * @author hadoop
 * 
 */
public class SecondarySort
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		FileInputFormat.addInputPath(job, new Path(
				"hdfs://172.2.48.88:9000/input/input/soso.txt"));
		FileOutputFormat.setOutputPath(job, new Path(
				"hdfs://172.2.48.88:9000/output/sort/"));
