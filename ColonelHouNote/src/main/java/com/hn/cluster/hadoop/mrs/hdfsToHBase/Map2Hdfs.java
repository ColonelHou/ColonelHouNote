package com.hn.cluster.hadoop.mrs.hdfsToHBase;
...
/**
 * 创建hbase表 hbase(main):015:0> create 'hdfsToHBase', 'cf' 0 row(s) in 1.0240
 * seconds
 * 
 * => Hbase::Table - hdfsToHBase 把map结果直接写到hbase里
 * 
 * @author hadoop
 * 
 */
public class Map2Hdfs
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		FileInputFormat.addInputPath(job, new Path(
				"hdfs://172.2.48.88:9000/input/input/hdfsToHBase"));
