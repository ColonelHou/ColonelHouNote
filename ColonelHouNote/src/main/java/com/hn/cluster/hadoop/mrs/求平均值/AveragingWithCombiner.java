package com.hn.cluster.hadoop.mrs.求平均值;
 ...
 * 
 * 
 * 1.下载数据流http://data.nber.org/patents/apat63_99.zip 2.解压上传到HDFS 3.编写MR
 * 
 * @author hadoop
 * 
 */
public class AveragingWithCombiner
{
			...
			ClassNotFoundException, InterruptedException
	{
		...
		FileInputFormat.addInputPath(job, new Path(
				"hdfs://172.2.48.88:9000/input/input/apat63_99.txt"));
		FileOutputFormat.setOutputPath(job, new Path(
				"hdfs://172.2.48.88:9000/output/average/"));
