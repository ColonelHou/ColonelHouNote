...
public class SearcherUtil
{
	...
	public SearcherUtil()
	{
		...
		try
		{
			directory = FSDirectory.open(new File(
					"/opt/hn/developTools/eclipseWKSP/lu/index/two"));
			setDates();
	...
	public void searchByBoolean(int num)
	{
		try
		{
			...
			/*
			 * BooleanQuery可以连接多个子查询 Occur.MUST必须有 Occur.SHOULD可以有可以没有
			 * Occur.MUSE_NOT必须没有
			 */
			// 名字必须是zhangsan
